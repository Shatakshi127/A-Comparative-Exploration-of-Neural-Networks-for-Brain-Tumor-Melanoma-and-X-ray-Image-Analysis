...
import os
try:
    inpath = "C:/Users/Lenovo/XAI/Chest_Xray/input/data/" 
...
import pandas as pd
data = pd.read_csv(inpath + 'Data.csv')
...
class MultipleClassAUROC(Callback):
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        if mean_auroc > self.stats["best_mean_auroc"]:
            print({self.stats['best_mean_auroc']} a {mean_auroc})
