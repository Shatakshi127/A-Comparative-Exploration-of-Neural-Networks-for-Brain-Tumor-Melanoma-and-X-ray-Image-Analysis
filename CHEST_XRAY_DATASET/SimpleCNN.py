...
# Load entry data
BBox_List = pd.read_csv("C:/Users/Lenovo/XAI/Chest_Xray/BBox_List_2017.csv")
Data_Entry = pd.read_csv("C:/Users/Lenovo/XAI/Chest_Xray/Data_Entry_2017.csv")
...
image_paths = {os.path.basename(x): x for x in glob('C:/Users/Lenovo/XAI/Chest_Xray/images/*.png')}
