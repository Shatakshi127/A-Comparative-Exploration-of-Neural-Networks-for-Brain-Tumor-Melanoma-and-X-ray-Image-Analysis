# -*- coding: utf-8 -*-
"""Brain_Tumor_3_Efficientnetb4.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1l2MyzznywaoVfrGEhOH6jAjODOjCXqQX
"""
...
img_path=r'../input/brain-tumor-detection/no/No13.jpg'
...
sdir=r'../input/brain-tumor-detection'
...
model_name='EfficientNetB4'    #Similarly make changes for EfficientNetB1, EfficientNetB2, EfficientNetB3, EfficientNetB5, EfficientNetB6, EfficientNetB7
...
def lrp_algo(model, image):
    image = torch.unsqueeze(image, 0)
    # >>> Step 1: Extract layers
    layers = list(model.vgg16._modules['features']) \
                + [model.vgg16._modules['avgpool']] \
                + dense_to_conv(list(model.effficientnetb._modules['classifier']))
...
lrp_result = lrp_algo(model, image_tensor)
